...
-- Function to detect C++ project (CMakeLists.txt or .cpp files in root)
local function is_cpp_project()
  local cmakelists = vim.fn.glob 'CMakeLists.txt'
  return (cmakelists ~= '')
end

-- If in C++ project, set makeprg
